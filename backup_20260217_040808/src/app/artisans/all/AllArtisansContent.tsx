...
// src/app/artisans/all/AllArtisansContent.tsx
"use client";

import { useState, useEffect, Suspense } from "react";
import Image from "next/image";
import Link from "next/link";
import { useSearchParams } from "next/navigation"; // If you need it
import { 
  Users, 
  MapPin, 
  Star, 
...
// Wrap any component that might use useSearchParams
...
// If you have any child components that use useSearchParams, wrap them here
function ArtisansFilterBar() {
  const searchParams = useSearchParams(); // This would cause error if not wrapped
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-background/95">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-7xl">
        {/* Filters - Wrap any part that might use searchParams */}
