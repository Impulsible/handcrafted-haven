...
const TeamMember = ({ name, role, bio, image, social }: { 
  ...
  return (
    <div 
      className="group relative bg-card border border-primary/10 rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
...
const TestimonialCard = ({ quote, author, role, image, rating }: {
  ...
  return (
    <div className="bg-card border border-primary/10 rounded-2xl p-6 hover:shadow-lg transition-all">
  ...
  return (
    <div className="flex gap-4 relative">
      ...
      <div className="pb-8">
        ...
        <h3 className="text-lg font-heading font-bold mt-1">{title}</h3>
...
const ValueCard = ({ icon, title, description }: {
  ...
  return (
    <div className="bg-card border border-primary/10 rounded-2xl p-6 hover:shadow-lg transition-all group hover:-translate-y-1 duration-300">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-background/95">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 max-w-7xl relative">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center px-3 py-1 bg-primary/10 backdrop-blur-sm rounded-full mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold mb-6">
              ...
              <span className="text-gradient block">Preserving Heritage</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                className="bg-gradient-to-r from-primary to-secondary text-white px-8 py-6 text-lg group"
              >
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Artisans Worldwide</p>
          </div>
          <div className="text-center">
            <div className="text-3xl sm:text-4xl font-bold text-primary mb-2">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">Years of Craftsmanship</p>
          </div>
        </div>
      </section>

      {/* Our Story Section */}
      <section className="bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating Quote Card */}
              <div className="absolute -bottom-6 -left-6 bg-card border border-primary/10 rounded-2xl p-6 shadow-xl max-w-xs">
                <Quote className="h-8 w-8 text-primary/20 mb-2" />
                <p className="text-sm italic mb-4">
                  "Every piece tells a story of tradition, skill, and passion. We're just here to help share those stories."
                </p>
                <p className="font-semibold">Elena Chen</p>
      ...
      {/* Contact Section */}
      <section className="bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">hello@handcraftedhaven.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">123 Artisan Lane, Creative District, NY 10001</p>
                  </div>
                </div>
            ...
            <div className="bg-card border border-primary/10 rounded-2xl p-8">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-lg border border-primary/20 bg-background focus:outline-none focus:ring-2 focus:ring-primary/30"
                ...
                <Button className="w-full bg-gradient-to-r from-primary to-secondary text-white py-6">
                  Send Message
                </Button>
              </form>
            </div>
