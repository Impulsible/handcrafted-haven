...
import { 
  ShoppingBag, Search, User, Menu, Heart, X, ChevronRight, Home, 
  Store, Users, Grid, Info, Mail, Phone, MapPin, ShoppingCart,
  Package, LogOut, Settings, CreditCard, ChevronDown
} from "lucide-react";
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2.5 dropdown-container">
              ...
              <div className="relative">
                <button 
                  ...
                  className="p-2 hover:bg-accent/10 rounded-full transition-colors relative group"
                >
                  <ShoppingBag className="h-4.5 w-4.5 text-foreground group-hover:scale-110 transition-transform" />
                  {itemCount > 0 && (
                    <span className="absolute -top-1 -right-1 h-4.5 w-4.5 rounded-full bg-secondary text-white text-[11px] flex items-center justify-center font-bold shadow-sm group-hover:scale-110 transition-transform">
